 ...
 * @author ffsga
 */
public class ListEleve extends BaseForm{
    
     Form current;

    public ListEleve(Resources res) {
        super("Gestion Eleve:", BoxLayout.y());
       ...
       // rbs[0].setSelected(true);
        ...
        ArrayList<Eleve> ListPub = ServiceEleve.getInstance().getAllPublication();
        for (Eleve Pub : ListPub) {
    ...
    private void addButton( Eleve Pub,Resources res) {
       ...
       Container cont = new Container();
        ...
        Label Prenomtxt = new Label("" + Pub.getPrenom(), "NewsTopLine");
        Label Agetxt = new Label("" + Pub.getAge(), "NewsTopLine");
        Label Idptxt = new Label("" + Pub.getIdp(), "NewsTopLine");
        Label Idjtxt = new Label("" + Pub.getIdj(), "NewsTopLine");
        ...
        if (Dialog.show("Suppression", "Vous Voulez Supprimer cet Publication ? ", "Non", "Oui")) {
            ...
            dig.dispose();
            if(ServiceEleve.getInstance().deleteEleve(Pub.getIde())){
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierEleve(res,Pub).show();
        });
        ...
        cont.add( BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(Idptxt),
                BoxLayout.encloseX(Idjtxt,lModifier, lsup)));
